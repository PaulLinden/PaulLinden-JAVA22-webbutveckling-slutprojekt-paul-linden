...
<body>
	...
	<nav class="pageNav">
		<form action="changePage" method="get">
			<select name="Page">
	...
	<form action="OWservlet" method="get"
		...
		City:<input type="text" name="city" pattern=".{1,}[a-zA-Z]"
			title="Only A-Z, a-z." /><br /> 
		Country:<input type="text" name="country" pattern=".{1,}[a-zA-Z]" title="Only A-Z, a-z." /><br />
			<input type="submit" value="go" class="inputButton"/> <span> 
		
		<%
		weatherBean wBean = (weatherBean) request.getAttribute("wBean");

 		if (request.getAttribute("wBean") != null) {
 			out.print("The weather in " + wBean.getCityStr() + " is now a " + wBean.getCloudsStr() + ". Current Temperature is "
 			+ wBean.getTempStr() + " " + wBean.getUnit() + ".");
 			out.print("<br>");
